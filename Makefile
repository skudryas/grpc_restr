COMMON_CC_FLAGS_DEBUG = -Werror -Wno-\#pragma-messages -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-realloc -fno-builtin-free -fno-omit-frame-pointer -DDEBUGLOG -fsanitize=address -O0
COMMON_LD_FLAGS_DEBUG = -lasan -pthread

COMMON_CC_FLAGS_PROF = -Werror -Wno-\#pragma-messages -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-realloc -fno-builtin-free -fno-omit-frame-pointer -DREPL_PROFILE -DDEBUGLOG -O3
COMMON_LD_FLAGS_PROF = -pthread -ltcmalloc -lprofiler

COMMON_CC_FLAGS_RELEASE = -Werror -Wno-\#pragma-messages -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-realloc -fno-builtin-free -fno-omit-frame-pointer -DQUIETLOG -O3
